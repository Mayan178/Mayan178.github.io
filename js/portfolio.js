...
// this function changs the slide when the dots are clicked
function currentSlide(n) {
    showSlides(slideIndex = n);
}

function showSlides(n) {
    var slides = document.getElementsByClassName("mySlides"); // this takes all elements with the class "mySlides" and stores them in the variable array "slides"
...
document.addEventListener("click", function(event) {
    ...
    //here we state that if the click happens on the happens on the cancel button or anywhere outside of the contact form and the click does not happen on the contact button or any of the contact links then call the closeform function
    ){
        closeForm()
    }
}, false)